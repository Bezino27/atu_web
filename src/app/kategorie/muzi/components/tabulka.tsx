  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardLabel}>
        {/* Odstránili sme cardLabelBar, čiara a padding sú teraz na texte */}
        <h2 className={styles.cardLabelText}>Slovenská Extraliga</h2>
      </div>

      {/* Tento obalový div zaručí responzivitu na mobile */}
